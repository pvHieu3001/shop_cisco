    ...
    return (
      <div>
        <div className='flex justify-between font-medium text-lg'>
          <label htmlFor=''>
            <span className=''>
              {variant.name}:<span className='ml-1 font-semibold'>{variantActives[key][variant.name]}</span>
            </span>
          </label>
        </div>
        ...
        <div className='space-y-7 lg:space-y-8'>
          ...
          <div className=''>
            ...
            <div className='flex items-center justify-between space-x-5'>
              <div className='flex text-2xl font-semibold'>{VND(parseFloat(price))}</div>
