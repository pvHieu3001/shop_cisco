      ...
      <div className='space-y-7 2xl:space-y-8'>
        ...
        <div>
          ...
          <div className='flex items-center mt-5 space-x-4 sm:space-x-5'>
            ...
            <Prices contentClass='py-1 px-2 md:py-1.5 md:px-3 text-lg font-semibold' price={44444444444} />
              ...
              {[LIST_IMAGES_DEMO[1], LIST_IMAGES_DEMO[2]].map((item, index) => {
                return (
                  <div key={index} className='aspect-w-11 xl:aspect-w-10 2xl:aspect-w-11 aspect-h-16'>
                    <img src={item} className='w-full rounded-2xl object-cover' alt='product detail 1' />
                  </div>
                )
              })}
            </div>
