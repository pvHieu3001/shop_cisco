    ...
    return (
      <div className='flex items-start space-x-4 sm:space-x-6'>
        ...
        <div className='flex-1'>
          <label htmlFor='Stripe' className='flex items-center space-x-4 sm:space-x-6'>
            <div
            ...
            >
              <img
                ...
                src='https://icons.veryicon.com/png/o/business/online-payment/payment-platform-stripe.png'
                alt=''
              />
            </div>
  ...
  const renderInterNetBanking = () => {
    ...
    return (
      <div className='flex items-start space-x-4 sm:space-x-6'>
        ...
        />
        <div className='flex-1'>
          <label htmlFor='Momo-Banking' className='flex items-center space-x-4 sm:space-x-6'>
            <div
              className={`p-2.5 rounded-xl border-2 ${
                active ? 'border-slate-600 dark:border-slate-300' : 'border-gray-200 dark:border-slate-600'
              }`}
            >
              <img
                className='w-[40px] h-[40px]'
                src='https://developers.momo.vn/v3/assets/images/brand-d8cdb07bcd21d30e67592a1cd6f8c6c6.png'
                alt=''
              />
            </div>
