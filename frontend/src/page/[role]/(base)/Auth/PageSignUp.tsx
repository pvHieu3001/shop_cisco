  ...
  return (
    <>
      <Modal title='Enter OTP' open={isModalOpen} footer={false} closeIcon={false}>
        <p>
          OTP sent to <span className='text-red-500'>"{watch('email')}"</span> within 1 minute, please check your email
          !
        </p>
        ...
        <button
          ...
          className={`mt-5 cursor-pointer bg-black rounded-[20px] text-white py-2 px-5 font-[700] ${
            isVerifyToken && 'cursor-not-allowed'
          }`}
        >
          Confirm
        </button>
          ...
          <div className='max-w-md mx-auto space-y-6 '>
            ...
            <form className='grid grid-cols-1 gap-6' onSubmit={handleSubmit(onSubmit)}>
              ...
              <label className='block'>
                ...
                <Input {...register('email')} type='email' placeholder='example@example.com' className='mt-1' />
              ...
              <ButtonPrimary loading={isLoadingSignUp} disabled={isLoadingSignUp} type='submit'>
                Đăng kí
              </ButtonPrimary>
            </form>
          </div>
