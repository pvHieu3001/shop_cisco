          ...
          <div className='flex flex-col md:flex-row'>
            <div className='flex-shrink-0 flex items-start'>
              ...
              <div className='relative rounded-full overflow-hidden flex'>
                <img src={dataItem?.data.image} alt='' className='w-32 h-32 rounded-full object-cover z-0' />
            ...
            <div className='flex-grow mt-10 md:mt-0 md:pl-16 max-w-3xl space-y-6'>
              ...
              <div>
                ...
                <div className='mt-1.5 flex'>
                  ...
                  <Form.Item name='email'>
                    <Input name='email' className='!rounded-l-none w-[400px]' placeholder='example@email.com' />
                  </Form.Item>
                </div>
              </div>
              ...
              <div>
                ...
                <div className='mt-1.5 flex'>
                  ...
                  <Form.Item name='address'>
                    <Input name='address' className='!rounded-l-none w-[400px]' defaultValue='New york, USA' />
                  </Form.Item>
                </div>
              </div>
              ...
              <div>
                ...
                <Form.Item name='county' rules={[{ required: true }]}>
                  <SelectAntd style={{ width: '100%' }} options={[{ value: 'Việt Nam', label: 'VietNam' }]} />
                </Form.Item>
              </div>
              ...
              <div>
                ...
                <div className='mt-1.5 flex'>
                  ...
                  <Form.Item name='phone' rules={[{ required: true }]}>
                    <Input name='phone' className='!rounded-l-none w-[400px]' defaultValue='003 888 232' />
                  </Form.Item>
                </div>
              </div>
              {/* ---- */}
